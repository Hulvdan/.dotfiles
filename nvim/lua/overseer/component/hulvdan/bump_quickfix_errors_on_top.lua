    ...
    constructor = function(params)
        ...
        return {
            ...
            on_exit = function(self, task, code)
                ...
                currentType = false
                for i, qfentry in ipairs(vim.fn.getqflist()) do
                    -- NOTE: qfentry looks like
                    -- {
                    --     ["end_lnum"] = 0,
                    --     ["pattern"] = ,
                    --     ["bufnr"] = 0,
                    ...
                    --     ["valid"] = 0,
                    --     ["type"] = ,
                    --     ["text"] =   (compiling source file '../../src/bf_exe_game.cpp'),
                    --     ["end_col"] = 0,
                    --     ["module"] = ,
                    --     ["lnum"] = 0,
                    --     ["vcol"] = 0,
                ...
                for i, v in ipairs(nonErrors) do
                    table.insert(newqflist, v)
                end
